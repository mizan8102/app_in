...
class TickingSystemApiV2Controller extends Controller
{
    ...
    public function StorePOSItemTransaction(Request $r){
        ...
        $isStore = Http::post("http://159.223.67.50/chiklee_test_server/chiklee_api/public/api/ticket_api_v2/item-isssue-create-one",$resultArr)->json();
        return [
    ...
    public function StoreOrderItemTransaction(Request $r){
        ...
        // return $resultArr;
        $isStore = Http::post("http://159.223.67.50/chiklee_test_server/chiklee_api/public/api/ticket_api_v2/item-isssue-create-one-take-order",$resultArr)->json();
        return [
            'status'=>$isStore['status'],
            'reason'=>$isStore['reason'],
            'issue_master_id'=>$isStore['issue_master_id'],
    ...
    public function StoreOrderPaymentTransaction(Request $r){
        ...
        // return $resultArr;
        $isStore = Http::post("http://159.223.67.50/chiklee_test_server/chiklee_api/public/api/ticket_api_v2/item-isssue-create-one-take-order-payment",$resultArr)->json();
        return [
            'status'=>$isStore['status'],
            'reason'=>$isStore['reason'],
            'issue_master_id'=>$isStore['issue_master_id'],
