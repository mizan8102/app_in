...
<head>
    ...
    <title>Daily Cash Receive (Storewise Userwise Sell)</title>
            ...
            <div class="column3">
                <div class="head_middle">
                    ...
                    <div style="text-align: center; padding-top:-45px; font-size: 12pt;">
                        ...
                        <span>Storewise User Wise Sell</span>
                        </p>
                    </div>
                </div>
            </div>
            <div class="column1">
                <p style="text-align: right; font-size:12px;">Chiklee#D_01D</p>
            </div>
        </div>
            ...
            <table width="100%">
                <thead>
                    <tr style="background-color: rgb(3,73,91);">
                        ...
                        <th></th>
                        <th style="text-align: center; color: rgb(255,255,255);" width = "20%">User Name</th>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid black;">
                        ...
                        <td></td>
                        <td style="text-align: left;">Sajib</td>
                    ...
                    <tr style="border-bottom: 1px solid black;">
                        ...
                        <td></td>
                        <td style="text-align: left;">Humayun</td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td style="text-align: right;"><strong>422.00</strong></td>
                        <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td style="text-align: left;">Faruk</td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td style="text-align: left;">Imran</td>
                    ...
                    <tr>
                        <td style="text-align: right;"colspan ="2"><strong>Total</strong></td>
                        <td></td>
                        <td style="text-align: right;"><strong>263.00</strong></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td style="text-align: right;"colspan ="3"><strong>Grand Total</strong></td>
                        <td style="text-align: right;"><strong>685.00</strong></td>
                        <td></td>
                    </tr>
                </tbody>
            </table>
