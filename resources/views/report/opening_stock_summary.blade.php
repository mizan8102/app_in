        ...
        <table width="100%" style="margin-top:60px;">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align: center;">27-Mar-23</td>
                    <td style="text-align: left;">Polao</td>
                    <td style="text-align: center;">KG</td>
                    <td style="text-align: center;">15.00</td>
                    <td style="text-align: right;">985.00</td>
                    <td style="text-align: right;">3467.00</td>
                    <td style="text-align: left;">Good</td>
                </tr>
                <tr>
                    <td style="text-align: center;">02</td>
                    <td style="text-align: center;">2</td>
                    <td style="text-align: center;">28-Mar-23</td>
                    <td style="text-align: left;">Mutton</td>
                    <td style="text-align: center;">KG</td>
                    <td style="text-align: center;">15.00</td>
                    <td style="text-align: right;">1280.00</td>
                    <td style="text-align: right;">74385.00</td>
                    <td style="text-align: left;">Good</td>
                </tr>
                <tr style="border-bottom: 1px solid black;">
                    <td style="text-align: right;"colspan ="5"><strong>Sub Total: </strong></td>
                    <td style="text-align: right;"><strong>{{number_format(96, 2, '.', ',')}}</strong></td>
                    <td></td>
