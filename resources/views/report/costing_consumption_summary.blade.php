...
<body>
        ...
        <div style="margin-left:3px; margin-top:20px;">
            ...
            <strong>**We may Group by Restaurant/ Master Group/ Group</strong> <br>
            </p>
        ...
        <div style="margin-left:3px; margin-top:50px;">
         <h5 style="text-decoration: underline; margin-left:3px;">Items with Consumption</h5>
        </div>
        <table width="100%" style="margin-top:0px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">29-Mar-23</td>
        ...
        <p style="font-size:16px;">**Items with Latest Effective Date</p>
         <h5 style="text-decoration: underline; margin-left:6px;">Items without Consumption</h5>
         <table width="100%" style="margin-top:0px;">
            <thead>
                <tr style="background-color: rgb(3,73,91);">
                <th style="text-align: center; color: rgb(255,255,255);">SL</th>
