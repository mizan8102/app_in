            ...
            <table width="100%" style="margin-top:60px;">
                <thead>
                    <tr style="background-color: rgb(3,73,91);">
                        ...
                        <th style="text-align: center; color: rgb(255,255,255);">Orchid</th>
                        <th style="text-align: center; color: rgb(255,255,255);">Happy Zone</th>
                        <th style="text-align: center; color: rgb(255,255,255);">Mini Kitchen</th>
                        <th style="text-align: center; color: rgb(255,255,255);">Fuchka Zone</th>
                        <th style="text-align: center; color: rgb(255,255,255);">Lotus</th>
