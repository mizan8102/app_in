...
<body>
        ...
        <div class="column3">
            <div class="head_middle">
                ...
                <div style="text-align: center; padding-top:-40px;">
                    <p style="text-decoration:underline; font-size: 14pt;"><b>Issue Summery</b><br>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div style="margin-left:3px; margin-top:20px;">
        <p style="text-align: left; font-size: 12px">
            ...
            <b> Period: {{ request()->input('from') }} {{ request()->input('to') }} </b><br>
        </p>
    ...
    <table width="100%" style="margin-top:90px;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;">{{ $item->issue_number }}</td>
                <td style="text-align: center;">{{ date('Y-m-d', strtotime($item->issue_date)) }}</td>
                <td style="text-align: left;">{{ $item->sl_name }}</td>
                <td style="text-align: right;">{{number_format($item->total_issue_amt_local_curr, 2, '.', ',')}}</td>
            ...
            <tr style="border-bottom: 1px solid black;">
                ...
                $total += $item->total_issue_amt_local_curr;
                }
                @endphp
                <td style="text-align: right;" colspan="1"><strong>{{number_format($total, 2, '.', ',')}}</strong></td>
