        ...
        <div class="column3">
            <div class="head_middle">
                ...
                <div style="text-align: center; padding-top:-40px;">
                    <p style="text-decoration:underline; font-size: 14pt;"><b>Receive Summery</b><br>
                    </p>
                </div>
            </div>
        </div>
    ...
    <table width="100%" style="margin-top:90px;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;">{{ $item->receiveDate }}</td>
                <td style="text-align: left;">{{ $item->supplierName }}</td>
                <td style="text-align: right;">{{number_format($item->totalReceiveAmount, 2, '.', ',')}}</td>
            ...
            $totalamnt = 0;
            foreach ($grn as $item) {
            $totalamnt += $item->totalReceiveAmount;
            }
            @endphp
                <td style="text-align: right;" colspan="4"><strong>Total: </strong></td>
                <td style="text-align: right;" colspan=""><strong>{{number_format($totalamnt, 2, '.', ',')}}</strong></td>
                <!-- <td></td> -->
                <td></td>
            </tr>
        </tbody>
    </table>
    <p style="font-size: x-small;">** Delivery Date Past but Open</p>
