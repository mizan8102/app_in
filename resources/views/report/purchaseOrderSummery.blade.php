...
<body>
        ...
        <div class="column3">
            <div class="head_middle">
                ...
                <div style="text-align: center; padding-top:-40px;">
                    <p style="text-decoration:underline; font-size: 14pt;"><b>Purchase Order Summary</b><br>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div style="margin-left:3px; margin-top:20px;">
        <p style="text-align: left; font-size: 12px">
            <b>Open PO till date: {{ request()->input('from') }} to {{ request()->input('to') }} </b><br>
        </p>
    ...
    <table width="100%" style="margin-top:90px;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;">{{ $item->poDate }}</td>
                <td style="text-align: center;">{{ $item->supplierName }}</td>
                <td style="text-align: center;">{{ $item->MasterGroupName }}</td>
                <td style="text-align: center;">{{ $item->deliveryDate }}</td>
                <td style="text-align: center;">{{ $item->poAmount }}</td>
            ...
            <tr style="border-bottom: 1px solid black;">
                ...
                <td style="text-align: right;" colspan=""><strong>
                        @php
                        $total = 0;
                        foreach ($pos as $item) {
                        $total += $item->poAmount;
