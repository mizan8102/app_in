...
<head>
    ...
    <title>Report Z_01 Store Wise Item List</title>
...
<style type="text/css">
    ...
    <body>
        <div class="row" style="none">
            ...
            <div class="column3">
                <div class="head_middle">
                    ...
                    <div style="text-align: center; padding-top:-40px;">
                        <p style ="font-size:14px;">Store Wise Item List<br>
            ...
            <div class="column1">
                <p style="text-align: right; font-size:12px;">Chiklee#Z_01</p>
            </div>
        </div>
            <div style="margin-left:5px; margin-top:20px; display:block;">
                <div class="report_params_areas" style="float:left;height:20px;width:50%">
                    <span style="text-align: right; font-size:12px"><b> Product Type: </b>{{$stores[0]->prod_type_name	 ?? ''}}</span>
                </div>
            ...
            <table width="100%" style="margin-top:5px;">
                <thead>
                    <tr style="background-color: rgb(3,73,91);">
                        ...
                        <th style="text-align: center; color: rgb(255,255,255);">Sub Group</th>
                        ...
                        <th style="text-align: center; color: rgb(255,255,255);">Item Rate</th>
                ...
                @endphp
                    @foreach ($data as $key => $store)
                        <tr>
                            ...
                            {!! '<img src="data:image/png;base64,' . DNS1D::getBarcodePNG($store->itm_code, 'C128') . '" alt="barcode" style="padding:2px 5px;height:20px;"  />' !!}

                          
                        </td>
                            <td style="text-align: center;">{{$store->itm_code}}</td>
                            <td style="text-align: left;">{{$store->subGroupName}}</td>
                            <td style="text-align: left;">{{$store->itemName}}</td>
                            <td style="text-align: left; font-size:14px;">{{$store->itemNameBn}}</td>
                            <td style="text-align: right;">{{number_format($store->itemRate, 2, '.', ',')}}</td>
