...
<body>
<form method="GET"  action="{{url('C_02A')}}"
   @csrf
<div class="card">
    <div class="container">
        <div class="card-body">
...
@if(request('StoreId')) 
    ...
    <table width="100%" style="margin-top:20px;">
        <thead>
            <tr style="background-color: rgb(3,73,91);">
                ...
                <th style="text-align: center; color: rgb(255,255,255);">Item Name[R]</th>
        ...
        <tbody>
            ...
            @endforeach
                <tr style="border-bottom: 1px solid black;">
                    ...
                    <td style="text-align: center;"><strong>{{number_format(collect($openings)->sum('qty'))}}</strong></td>
                    <td></td>
    ...
    <div class="row" id= "item" style="margin-bottom: 3px solid red;">
        <div class="col-md-5">
            ...
            <a href="{{url('/C_02A-pdf')}}?&StoreId={{request('StoreId')}}">
