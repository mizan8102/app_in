...
<html>
<head>
    <title>Item Stock Summery</title>
</head>
<style type="text/css">
    @page {
            header: page-header;
    ...
    <div class="row" style="none">
        ...
        <div class="column3">
            <div class="head_middle">
                ...
                <div style="text-align: center; padding-top:-40px;">
                    <p style="text-decoration:underline; font-size: 14pt;"><b>Item Stock Summery</b><br>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div style="margin-left:3px; margin-top:20px;">
            <p style="text-align: left; font-size: 12px">
                <b> Product Category: </b> Dry Item<br>
                <b>Store Name:</b><br>
                <b> Stock Date: </b>
                    @php 
        ...
        <table width="100%" style="margin-top:90px;">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align: left;">Polao Rice</td>
                    <td style="text-align: center;">1:1</td>
                    <td style="text-align: center;">5</td>
                    <td style="text-align: right;">{{number_format(100, 2, '.', ',')}}</td>
                    <td style="text-align: right;">{{number_format(500, 2, '.', ',')}}</td>
                ...
                <tr style="border-bottom: 1px solid black;">
                    ...
                    <td></td>
                    <td style="text-align: right;"colspan ="1"><strong>{{number_format(3000, 2, '.', ',')}}</strong></td>
                    <!-- <td style="text-align: right;"><strong>{{number_format(150, 2, '.', ',')}}/-</strong></td> -->
                    <td></td>
                </tr>
            </tbody>
        </table>
        <P style="font-size: x-small; margin: left 5px;">
            ** Items with Latest Effective Date
        </P>
