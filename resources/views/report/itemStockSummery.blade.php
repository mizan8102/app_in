...
<head>
    ...
    <title>Report C_02A Opening Stock Summary</title>
    ...
    <body>
            ...
            <div class="column3">
                <div class="head_middle">
                    ...
                    <div style="text-align: center; padding-top:-40px;">
                        <p>Opening Stock Summary<br>
                        </p>
                    </div>
                </div>
            </div>
            <div class="column1">
                <p style="text-align: right; font-size:12px;">Chiklee#C_02A</p>
            </div>
        </div>
        <div style="margin-left:5px; margin-top:20px; display:block;">
            ...
            <div class="report_params_areas" style="float:left;height:20px;width:50%">
                <span style="text-align: right; font-size:12px"><b> Store Name: {{$openings[0]->storeName ?? ''}}</b></span>
            </div>
            ...
            <table width="100%">
                <thead>
                    <tr style="background-color: rgb(3,73,91);">
                        ...
                        <th style="text-align: center; color: rgb(255,255,255);">Stock Date</th>
                ...
                @if ($openings)
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">{{$opening->grnNo}}</td>
                        <td style="text-align: center;">{{Date('m/d/Y',strtotime($opening->stockDate))}}</td>
                        <td style="text-align: left;">{{$opening->itemName}}</td>
                        <td style="text-align: center;">{{$opening->uom}}</td>
                        <td style="text-align: center;">{{$opening->qty}}</td>
                        <td style="text-align: right;">{{number_format($opening->rate, 2, '.', ',')}}</td>
                        <td style="text-align: right;">{{number_format($opening->amount, 2, '.', ',')}}</td>
                    ...
                    <tr style="border-bottom: 1px solid black;">
                        ...
                        <td style="text-align: center;"><strong>{{collect($openings)->sum('qty')}}</strong></td>
                        <td></td>
                        <td style="text-align: right;"><strong>{{number_format(collect($openings)->sum('amount'),2, '.', ',')}}</strong></td>
                        <td></td>
                    </tr>
                </tbody>
            </table> 
        </div>
        {{-- <p style="font-size:16px;">**Items with Latest Effective Date</p> --}}
