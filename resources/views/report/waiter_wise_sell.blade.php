            ...
            <table width="100%" style="margin-top:60px;">
                <thead>
                    <tr style="background-color: rgb(3,73,91);">
                        ...
                        <th style="text-align: center; color: rgb(255,255,255);">Robiul</th>
                        <th style="text-align: center; color: rgb(255,255,255);">Akash</th>
                        <th style="text-align: center; color: rgb(255,255,255);">rasel</th>
                        <th style="text-align: center; color: rgb(255,255,255);">Iqbal</th>
                        <th style="text-align: center; color: rgb(255,255,255);">kabir</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: center;">03/29/2023</td>
                        <td style="text-align: right;">985.00</td>
                        <td style="text-align: right;">3567.00</td>
                        <td style="text-align: right;">752.00</td>
                        <td style="text-align: right;">89763.00</td>
                        <td style="text-align: right;">7852.00</td>
                        <td style="text-align: right;">12986.00</td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">02</td>
                        <td style="text-align: center;">05/29/2023</td>
                        ...
                        <td style="text-align: right;">1896.00</td>
                    </tr>
                    <tr style="border-bottom: 1px solid black;">
                        ...
                        <td style="text-align: right;"><strong>{{number_format(3654, 2, '.', ',')}}</strong></td>
                        <td style="text-align: right;"><strong>{{number_format(9867, 2, '.', ',')}}</strong></td>
                        <td style="text-align: right;"><strong>{{number_format(13432, 2, '.', ',')}}</strong></td>
                        <td style="text-align: right;"><strong>{{number_format(98098, 2, '.', ',')}}</strong></td>
                        <td style="text-align: right;"><strong>{{number_format(896, 2, '.', ',')}}</strong></td>
                    </tr>
                </tbody>
            </table>
